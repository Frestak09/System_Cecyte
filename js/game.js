...
new Vue({
    ...
    async mounted() {
        await Swal.fire(
            'Juego Del Ahorcado',
            'Producido por estudiante  - Brandon Uriel Pérez Padilla',
            'Informacion'
        );
        this.resetGame();
    },
    methods: {
        ...
        checkGameStatus() {
            if (this.playerWins()) {
                Swal.fire("Has Ganadoo! La Palabra Es: " + this.getUnhiddenWord());
                this.resetGame();
            }
            if (this.playerLoses()) {
                Swal.fire("Has Perdido T_T . La Palabra Es: " + this.getUnhiddenWord());
                this.resetGame();
            }
        },
        getUnhiddenWord() {
        ...
        async chooseWord() {
            ...
            if (!words.length) {
                await Swal.fire("Porfavor Agrega Mas Palabras Para Juegar (Ve a el administrador de palabras)");
